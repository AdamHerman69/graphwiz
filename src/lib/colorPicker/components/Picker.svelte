<script lang="ts">
	...
	$: indicatorColor = colord({ h, s, v, a: 1 }).toHex();
...
>
	<svelte:component this={components.pickerIndicator} {pos} {isDark} color={indicatorColor} />
...
<style>
	.picker {
		...
		border-radius: var(--picker-radius, 12px);
		outline: none;
		user-select: none;
